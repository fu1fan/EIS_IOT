...
void Intserve(void)
{
    ...
    // SDIO2 = 0;
    // SDIO3 = 0;
	gpio_write_pin(AD9959_PWR_PIN, 0);
	gpio_write_pin(AD9959_CS_PIN, 1);
	gpio_write_pin(AD9959_SCK_PIN, 0);
	gpio_write_pin(AD9959_UPDATA_PIN, 0);
	gpio_write_pin(AD9959_PS0_PIN, 0);
	gpio_write_pin(AD9959_PS1_PIN, 0);
	gpio_write_pin(AD9959_PS2_PIN, 0);
	gpio_write_pin(AD9959_PS3_PIN, 0);
	gpio_write_pin(AD9959_SDIO0_PIN, 0);
	gpio_write_pin(AD9959_SDIO1_PIN, 0);
	gpio_write_pin(AD9959_SDIO2_PIN, 0);
	gpio_write_pin(AD9959_SDIO3_PIN, 0);
}
...
{
  	// Reset = 0;
	gpio_write_pin(AD9959_RST_PIN, 0);
	delay1(1);
	// Reset = 1;
	gpio_write_pin(AD9959_RST_PIN, 1);
	delay1(30);
	// Reset = 0;
	gpio_write_pin(AD9959_RST_PIN, 0);
}
...
void IO_Update(void)
{
	...
	delay1(2);
	// UPDATE = 1;
	gpio_write_pin(AD9959_UPDATA_PIN, 1);
	delay1(4);
	// UPDATE = 0;
	gpio_write_pin(AD9959_UPDATA_PIN, 0);
}
...
//写入地址
	...
	gpio_write_pin(AD9959_SCK_PIN, 0);
	// CS = 0;
	gpio_write_pin(AD9959_CS_PIN, 0);
	for(i=0; i<8; i++)
	{
		// SCLK = 0;
		gpio_write_pin(AD9959_SCK_PIN, 0);
		...
		// SDIO0= 1;
		gpio_write_pin(AD9959_SDIO0_PIN, 1);
		else
		// SDIO0= 0;
		gpio_write_pin(AD9959_SDIO0_PIN, 0);
		// SCLK = 1;
		gpio_write_pin(AD9959_SCK_PIN, 1);
		ControlValue <<= 1;
	}
	// SCLK = 0;
	gpio_write_pin(AD9959_SCK_PIN, 0);
