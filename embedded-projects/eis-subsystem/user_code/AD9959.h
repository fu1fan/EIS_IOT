...
#ifndef USER_CODE_AD9959_H_
#define USER_CODE_AD9959_H_

#include "driver_headfile.h"

// 管脚定义
#define AD9959_CS_PIN   	PIN_GPIO4_2
#define AD9959_SCK_PIN  	PIN_GPIO3_15
#define AD9959_UPDATA_PIN 	PIN_GPIO4_4

#define AD9959_PS0_PIN 	    PIN_GPIO5_2
#define AD9959_PS1_PIN 	    PIN_GPIO3_7
#define AD9959_PS2_PIN 	    PIN_GPIO4_3
#define AD9959_PS3_PIN 	    PIN_GPIO4_1

#define AD9959_SDIO0_PIN    PIN_GPIO3_14
#define AD9959_SDIO1_PIN    PIN_GPIO3_12
#define AD9959_SDIO2_PIN    PIN_GPIO3_10
#define AD9959_SDIO3_PIN    PIN_GPIO3_13

#define AD9959_PWR_PIN      PIN_GPIO5_3
#define AD9959_RST_PIN      PIN_GPIO3_11
