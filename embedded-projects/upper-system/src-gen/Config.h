...
#define MOTOR1_RUN_LED_I0 gpio_iopack(GPIO_PORT_I, GPIO_PIN_0) /* PI[0] */
#define MOTOR1_RUN_LED_I0_CFG                       \
	(GPIO_MODE_MODER_OUTPUT |                       \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
...
#define MOTOR2_RUN_LED_I1 gpio_iopack(GPIO_PORT_I, GPIO_PIN_1) /* PI[1] */
#define MOTOR2_RUN_LED_I1_CFG                       \
	(GPIO_MODE_MODER_OUTPUT |                       \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR1_ERR_LED_I2 gpio_iopack(GPIO_PORT_I, GPIO_PIN_2) /* PI[2] */
#define MOTOR1_ERR_LED_I2_CFG                       \
	(GPIO_MODE_MODER_OUTPUT |                       \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR2_ERR_LED_I4 gpio_iopack(GPIO_PORT_I, GPIO_PIN_4) /* PI[4] */
#define MOTOR2_ERR_LED_I4_CFG                       \
	(GPIO_MODE_MODER_OUTPUT |                       \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR1_BREAK_I3 gpio_iopack(GPIO_PORT_I, GPIO_PIN_3) /* PI[3] */
#define MOTOR1_BREAK_I3_CFG                         \
	(GPIO_MODE_MODER_INPUT |                        \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR2_BREAK_I5 gpio_iopack(GPIO_PORT_I, GPIO_PIN_5) /* PI[5] */
#define MOTOR2_BREAK_I5_CFG                         \
	(GPIO_MODE_MODER_INPUT |                        \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define ENCODER_SPI_MISO_F2 gpio_iopack(GPIO_PORT_F, GPIO_PIN_2) /* PF[2] */
#define ENCODER_SPI_MISO_F2_CFG                     \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define ENCODER_SPI_MOSI_F3 gpio_iopack(GPIO_PORT_F, GPIO_PIN_3) /* PF[3] */
#define ENCODER_SPI_MOSI_F3_CFG                     \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
/*--------------------- HRTIM1 pins definitions ---------------------*/
#define MOTOR1_AH_E4 gpio_iopack(GPIO_PORT_E, GPIO_PIN_4) /* PE[4] */
#define MOTOR1_AH_E4_CFG                            \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR1_AL_E3 gpio_iopack(GPIO_PORT_E, GPIO_PIN_3) /* PE[3] */
#define MOTOR1_AL_E3_CFG                            \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR1_BH_E2 gpio_iopack(GPIO_PORT_E, GPIO_PIN_2) /* PE[2] */
#define MOTOR1_BH_E2_CFG                            \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR1_BL_E1 gpio_iopack(GPIO_PORT_E, GPIO_PIN_1) /* PE[1] */
#define MOTOR1_BL_E1_CFG                            \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR1_CH_D15 gpio_iopack(GPIO_PORT_D, GPIO_PIN_15) /* PD[15] */
#define MOTOR1_CH_D15_CFG                           \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR1_CL_D14 gpio_iopack(GPIO_PORT_D, GPIO_PIN_14) /* PD[14] */
#define MOTOR1_CL_D14_CFG                           \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR2_AH_D13 gpio_iopack(GPIO_PORT_D, GPIO_PIN_13) /* PD[13] */
#define MOTOR2_AH_D13_CFG                           \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR2_AL_D12 gpio_iopack(GPIO_PORT_D, GPIO_PIN_12) /* PD[12] */
#define MOTOR2_AL_D12_CFG                           \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR2_BH_D11 gpio_iopack(GPIO_PORT_D, GPIO_PIN_11) /* PD[11] */
#define MOTOR2_BH_D11_CFG                           \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR2_BL_D10 gpio_iopack(GPIO_PORT_D, GPIO_PIN_10) /* PD[10] */
#define MOTOR2_BL_D10_CFG                           \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR2_CH_D8 gpio_iopack(GPIO_PORT_D, GPIO_PIN_8) /* PD[8] */
#define MOTOR2_CH_D8_CFG                            \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
#define MOTOR2_CL_D7 gpio_iopack(GPIO_PORT_D, GPIO_PIN_7) /* PD[7] */
#define MOTOR2_CL_D7_CFG                            \
	(GPIO_MODE_MODER_ALTERNATE |                    \
	 GPIO_MODE_OTYPER_PUSHPULL |                    \
	 GPIO_MODE_OSPEEDR_VERYHIGH |                   \
	 GPIO_MODE_PUPDR_FLOATING |                     \
...
__STATIC_INLINE void Config_init(void) {
	...
	gpio_set_pin_mode(MOTOR1_RUN_LED_I0, MOTOR1_RUN_LED_I0_CFG);
	gpio_set_pin_mode(MOTOR2_RUN_LED_I1, MOTOR2_RUN_LED_I1_CFG);
	gpio_set_pin_mode(MOTOR1_ERR_LED_I2, MOTOR1_ERR_LED_I2_CFG);
	gpio_set_pin_mode(MOTOR2_ERR_LED_I4, MOTOR2_ERR_LED_I4_CFG);
	gpio_set_pin_mode(MOTOR1_BREAK_I3, MOTOR1_BREAK_I3_CFG);
	gpio_set_pin_mode(MOTOR2_BREAK_I5, MOTOR2_BREAK_I5_CFG);
	...
	gpio_set_pin_mode(ENCODER_SPI_MISO_F2, ENCODER_SPI_MISO_F2_CFG);
	gpio_set_pin_mode(ENCODER_SPI_MOSI_F3, ENCODER_SPI_MOSI_F3_CFG);
	...
	/* HRTIM1 */
	gpio_set_pin_mode(MOTOR1_AH_E4, MOTOR1_AH_E4_CFG);
	gpio_set_pin_mode(MOTOR1_AL_E3, MOTOR1_AL_E3_CFG);
	gpio_set_pin_mode(MOTOR1_BH_E2, MOTOR1_BH_E2_CFG);
	gpio_set_pin_mode(MOTOR1_BL_E1, MOTOR1_BL_E1_CFG);
	gpio_set_pin_mode(MOTOR1_CH_D15, MOTOR1_CH_D15_CFG);
	gpio_set_pin_mode(MOTOR1_CL_D14, MOTOR1_CL_D14_CFG);
	gpio_set_pin_mode(MOTOR2_AH_D13, MOTOR2_AH_D13_CFG);
	gpio_set_pin_mode(MOTOR2_AL_D12, MOTOR2_AL_D12_CFG);
	gpio_set_pin_mode(MOTOR2_BH_D11, MOTOR2_BH_D11_CFG);
	gpio_set_pin_mode(MOTOR2_BL_D10, MOTOR2_BL_D10_CFG);
	gpio_set_pin_mode(MOTOR2_CH_D8, MOTOR2_CH_D8_CFG);
	gpio_set_pin_mode(MOTOR2_CL_D7, MOTOR2_CL_D7_CFG);
