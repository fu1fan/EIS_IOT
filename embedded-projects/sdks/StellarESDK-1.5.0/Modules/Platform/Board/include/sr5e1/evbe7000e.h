...
/**
 * @file    evbe7000e.h
 * @brief   SR5E1-EVBE7000E board header file.
 *
 * @addtogroup PLATFORM
 * @addtogroup BOARD
 * @ingroup PLATFORM
 * @addtogroup EVBE7000E
 * @ingroup BOARD
 * @{
 */

#ifndef _EVBE7000E_H_
#define _EVBE7000E_H_
...
/* PortA pin settings. */
#define UART1_RX gpio_iopack(GPIO_PORT_A, GPIO_PIN_0)
#define UART1_RX_CFG                             \
...
#define UART1_TX gpio_iopack(GPIO_PORT_A, GPIO_PIN_1)
#define UART1_TX_CFG                             \
    (GPIO_MODE_MODER_ALTERNATE |                 \
     GPIO_MODE_OTYPER_PUSHPULL |                 \
     GPIO_MODE_OSPEEDR_LOW |                     \
...
#define SAR4_4_IO_CFG                            \
    (GPIO_MODE_MODER_ANALOG |                    \
     ...
     GPIO_MODE_SAFEVALR_LOW)
*/
#define USER_SW3 gpio_iopack(GPIO_PORT_C, GPIO_PIN_7)
#define USER_SW3_CFG                             \
...
#define SAR4_5_IO_CFG                            \
    (GPIO_MODE_MODER_ANALOG |                    \
     ...
     GPIO_MODE_SAFEVALR_LOW)
*/
#define USER_SW4 gpio_iopack(GPIO_PORT_C, GPIO_PIN_8)
#define USER_SW4_CFG                             \
    (GPIO_MODE_MODER_OUTPUT |                    \
     GPIO_MODE_OTYPER_PUSHPULL |                 \
     GPIO_MODE_OSPEEDR_HIGH |                    \
...
/* GPIOD[14] is used to drive the USER_LED6
...
#define HRTIM1_CHC2_CFG                          \
    (GPIO_MODE_MODER_ALTERNATE |                 \
     ...
     GPIO_MODE_SAFEVALR_LOW)
*/
#define USER_LED6 gpio_iopack(GPIO_PORT_D, GPIO_PIN_14)
...
/* GPIOD[15] is used to drive the USER_LED7
...
#define HRTIM1_CHC1_CFG                          \
    (GPIO_MODE_MODER_ALTERNATE |                 \
     ...
     GPIO_MODE_SAFEVALR_LOW)
*/
#define USER_LED7 gpio_iopack(GPIO_PORT_D, GPIO_PIN_15)
...
__STATIC_INLINE void evbe7000e_init(void) {
    ...
    gpio_set_pin_mode(USER_SW3, USER_SW3_CFG);
    gpio_set_pin_mode(USER_SW4, USER_SW4_CFG);
    ...
    gpio_set_pin_mode(USER_LED6, USER_LED6_CFG);
    gpio_set_pin_mode(USER_LED7, USER_LED7_CFG);
