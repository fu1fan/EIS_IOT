...
static void cordic_reset_paramters(cordic_driver_t *cdp) {
    ...
    cdp->dma_conf.dma_stream_wr_id    = DMA1_STREAM0_ID;
    cdp->dma_conf.dma_stream_rd_id    = DMA1_STREAM1_ID;
...
void cordic_set_dma_conf(cordic_driver_t *cdp, cordic_dma_conf_t *dma_conf) {

    cdp->dma_conf.dma_stream_wr_id    = dma_conf->dma_stream_wr_id;
    cdp->dma_conf.dma_stream_rd_id    = dma_conf->dma_stream_rd_id;
