...
struct spi_driver {
    ...
    spi_mode_t               mode;
    /**
     * @brief   SPI communication mode (full or half duplex).
     */
    spi_cmode_t              cmode;
    /**
     * @brief   SPI receive only mode flag.
     * @note    This flag is set on "true" for SPI master receive in half
     *          duplex mode, otherwise it is set on "false".
     */
    bool                     is_rxonly;
    /**
     * @brief   SPI baud rate.
