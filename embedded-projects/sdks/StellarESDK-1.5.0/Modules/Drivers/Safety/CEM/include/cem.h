...
/**
 * @name    Mask to select all faults of a CEM group
 * @{
 */
#define CEM_ALL_FAULTS_MASK                 0xFFFFU
/** @} */
 ...
 * @param[in] fault_msk fault mask specifing which faults to enable/disable
 *                      ('1' in position 'i' means that the fault i must be
 *                      enabled/disabled)
 ...
 * @api
 */
void cem_group_write_enable(cem_driver_t *cdp, uint16_t group_num,
                            uint32_t fault_msk, bool enable);
