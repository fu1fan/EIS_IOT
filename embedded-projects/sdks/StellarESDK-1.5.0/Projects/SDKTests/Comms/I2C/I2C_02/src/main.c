...
static i2c_dma_conf_t i2c_master_dma_conf;
static i2c_dma_conf_t i2c_slave_dma_conf;

/* This function configures I2C Master.*/
static void i2c_master_config(i2c_driver_t *idp) {

    /* Configure I2C Master DMA.*/
    i2c_master_dma_conf.dma_stream_tx_id = DMA1_STREAM0_ID;
    i2c_master_dma_conf.dma_stream_rx_id = DMA1_STREAM1_ID;
    i2c_master_dma_conf.dma_stream_bus_prio = DMA_PRIORITY_MAX;
    i2c_master_dma_conf.dma_stream_irq_prio = IRQ_PRIORITY_10;

    (void)i2c_set_prio(idp, IRQ_PRIORITY_10);
    (void)i2c_set_drv_mode(idp, I2C_DRV_MODE_ASYNCHRONOUS);
    (void)i2c_enable_dma(idp, true);
    i2c_set_dma_conf(idp, &i2c_master_dma_conf);
...
static void i2c_slave_config(i2c_driver_t *idp) {
    ...
    /* Configure I2C Master DMA.*/
    i2c_slave_dma_conf.dma_stream_tx_id = DMA1_STREAM2_ID;
    i2c_slave_dma_conf.dma_stream_rx_id = DMA1_STREAM3_ID;
    i2c_slave_dma_conf.dma_stream_bus_prio = DMA_PRIORITY_MAX;
    i2c_slave_dma_conf.dma_stream_irq_prio = IRQ_PRIORITY_10;

    (void)i2c_set_prio(idp, IRQ_PRIORITY_10);
    (void)i2c_set_drv_mode(idp, I2C_DRV_MODE_ASYNCHRONOUS);
    (void)i2c_enable_dma(idp, true);
    i2c_set_dma_conf(idp, &i2c_slave_dma_conf);
    (void)i2c_set_timing(idp, I2C_TIMING);
