...
int main(void) {
    ...
    spi_dma_conf_t spi_master_dma_conf, spi_slave_dma_conf;
    ...
    (void)spi_set_baud(&MASTER_SPID, SPI_BAUDRATE_DIV64);
    ...
    (void)spi_set_baud(&SLAVE_SPID, SPI_BAUDRATE_DIV32);
