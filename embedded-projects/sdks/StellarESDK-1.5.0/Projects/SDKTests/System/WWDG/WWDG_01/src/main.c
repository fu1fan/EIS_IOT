...
static void fccu_config(fccu_driver_t *fdp) {
	...
	/* Enable functional reset request on WWDG1 (FCCU ch10).*/
    fccu_set_ch_cfg(fdp, 10U, true, FCCU_RF_CONFIG_SW, false, false, NULL, FCCU_REACTION_LONG_FUNCTIONAL, false, false);
}
