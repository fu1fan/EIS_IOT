...
/* First block used by the EEPROM Emulation Driver.*/
#define EED_BLOCK_1                         0U

/* Second block used by the EEPROM Emulation Driver.*/
#define EED_BLOCK_2                         1U
...
int main(void)
{
    ...
    /* Configure EED blocks.*/
    eed_set_cfg(&EEDD, EED_BLOCK_1, EED_BLOCK_2);
