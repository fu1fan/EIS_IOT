...
struct adc_driver {
    ...
    /**
     * @brief   ADC regular mode DMA enable flag (false by default).
     */
    bool                     is_reg_dma_en;
    ...
    /**
     * @brief   Dual mode enable flag (false by default).
     */
    bool                     is_dual_mode_en;
    /**
     * @brief   Dual mode configuration.
     */
    adc_dual_mode_t          dual_mode;
    /**
     * @brief   Dual mode DMA configuration.
     */
    adc_dma_conf_t           dm_dma_conf;
    /**
     * @brief   Allocated dual mode DMA descriptor.
     * @note    DMA is used only for regular conversions.
     */
    const dma_descriptor_t   *dm_dma_descriptor;
    /**
     * @brief   Pointer to the uffer for dual mode conversions.
    ...
    /**
     * @brief   Analog watchdog enable flag.
     */
    bool                     is_aw_en[ADC_WATCHDOG_NUM];
    /**
     * @brief   Analog watchdog thresholds.
     */
    uint32_t                 aw_tr[ADC_WATCHDOG_NUM];
    /**
     * @brief   Analog watchdog channels.
     */
    uint32_t                 aw_ch[ADC_WATCHDOG_NUM];
    /**
...
bool adc_dev_is_master(adc_driver_t *adp);
