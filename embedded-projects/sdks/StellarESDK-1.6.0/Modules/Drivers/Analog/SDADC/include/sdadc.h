...
/**
 * @enum sdadc_tsel_t
 * SDADC trigger input selection configuration.
 */
typedef enum {
    SDADC_TSEL_ADC1_SW_TRGO,
    SDADC_TSEL_ADC2_SW_TRGO,
    SDADC_TSEL_TIM1_TRGO,
    SDADC_TSEL_TIM1_TRGO2,
    SDADC_TSEL_TIM8_TRGO,
    SDADC_TSEL_TIM8_TRGO2,
    SDADC_TSEL_TIM2_TRGO,
    SDADC_TSEL_TIM3_TRGO,
    SDADC_TSEL_TIM4_TRGO,
    SDADC_TSEL_TIM15_TRGO,
    SDADC_TSEL_HRTIM1_ADCTRIG1,
    SDADC_TSEL_HRTIM1_ADCTRIG2,
    SDADC_TSEL_HRTIM1_ADCTRIG3,
    SDADC_TSEL_HRTIM2_ADCTRIG1,
    SDADC_TSEL_HRTIM2_ADCTRIG2,
    SDADC_TSEL_HRTIM2_ADCTRIG3
} sdadc_tsel_t;

/**
 * @enum sdadc_tedge_t
 * SDADC trigger edge selection configuration.
 */
typedef enum {
    SDADC_TEDGE_FALLING_EDGE,
    SDADC_TEDGE_RISING_EDGE,
    SDADC_TEDGE_BOTH_EDGES
} sdadc_tedge_t;
...
/**
 * @name    SDADC Trigger Input Selection initializer
 * @{
 */
#define SDADC_MCR_TRIGSEL(_x_)                                       \
    ((((uint32_t)(_x_)) << SDADC_SDADC_MCR_TRIGSEL_Pos) & SDADC_SDADC_MCR_TRIGSEL)
/** @} */

/**
 * @name    SDADC Trigger Edge Selection initializer
 * @{
 */
#define SDADC_MCR_TRIGEDSEL(_x_)                                     \
    ((((uint32_t)(_x_)) << SDADC_SDADC_MCR_TRIGEDSEL_Pos) & SDADC_SDADC_MCR_TRIGEDSEL)
/** @} */
...
/**
 * @name    SDADC Watchdog Upper Threshold Value initializer
 * @{
 */
 ...
 * @note    This configuration becomes effective after sdadc_start.
 * @note    Output settling delay must be set at least to 16.
 *
 * @param[in] sdp       pointer to an @p sdadc_driver_t structure
...
/**
 * @brief   Enables and configures trigger.
 * @note    This configuration becomes effective after sdadc_start.
 *
 * @param[in] sdp       pointer to an @p sdadc_driver_t structure
 * @param[in] trg_sel   trigger input selection. It can be one of the following
 *                      values:
 *            @arg @ref SDADC_TSEL_ADC1_SW_TRGO
 *            @arg @ref SDADC_TSEL_ADC2_SW_TRGO
 *            @arg @ref SDADC_TSEL_TIM1_TRGO
 *            @arg @ref SDADC_TSEL_TIM1_TRGO2
 *            @arg @ref SDADC_TSEL_TIM8_TRGO
 *            @arg @ref SDADC_TSEL_TIM8_TRGO2
 *            @arg @ref SDADC_TSEL_TIM2_TRGO
 *            @arg @ref SDADC_TSEL_TIM3_TRGO
 *            @arg @ref SDADC_TSEL_TIM4_TRGO
 *            @arg @ref SDADC_TSEL_TIM15_TRGO
 *            @arg @ref SDADC_TSEL_HRTIM1_ADCTRIG1
 *            @arg @ref SDADC_TSEL_HRTIM1_ADCTRIG2
 *            @arg @ref SDADC_TSEL_HRTIM1_ADCTRIG3
 *            @arg @ref SDADC_TSEL_HRTIM2_ADCTRIG1
 *            @arg @ref SDADC_TSEL_HRTIM2_ADCTRIG2
 *            @arg @ref SDADC_TSEL_HRTIM2_ADCTRIG3
 * @param[in] trg_edge  trigger edge selection. It can be one of the following
 *                      values:
 *            @arg @ref SDADC_TEDGE_FALLING_EDGE
 *            @arg @ref SDADC_TEDGE_RISING_EDGE
 *            @arg @ref SDADC_TEDGE_BOTH_EDGES
 *
 * @api
 */
void sdadc_enable_trigger(sdadc_driver_t *sdp, sdadc_tsel_t trg_sel,
                          sdadc_tedge_t trg_edge);

/**
 * @brief   Enables Capture timestamp request.
 * @note    This configuration becomes effective after sdadc_start.
 *
 * @param[in] sdp       pointer to an @p sdadc_driver_t structure
 * @return              previous capture timestamp request status (true if
 *                      enabled, false otherwise).
 *
 * @api
 */
bool sdadc_enable_timestamp(sdadc_driver_t *sdp);
...
/**
 * @brief   Reads SDADC timestamp value.
 * @note    It must be used only when timestamp is enabled.
 *
 * @param[in] sdp       pointer to an @p sdadc_driver_t structure
 ...
 * @api
 */
uint32_t sdadc_read_timestamp(sdadc_driver_t *sdp);
...
/**
 * @brief   Gets FIFO size.
 *
 * @param[in] sdp       pointer to an @p sdadc_driver_t structure
 * @return              FIFO size. It can be one of the following value:
 ...
 * @api
 */
sdadc_fsize_t sdadc_get_fsize(sdadc_driver_t *sdp);
