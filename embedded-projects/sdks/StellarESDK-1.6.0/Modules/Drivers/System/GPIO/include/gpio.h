...
__STATIC_INLINE void gpio_set_pin_moder(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->MODER, 0x3U, (2 * pin), mode);
    }
}
...
__STATIC_INLINE void gpio_set_pin_otyper(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->OTYPER, 0x1U, pin, otype);
    }
}
...
__STATIC_INLINE void gpio_set_pin_ospeedr(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->OSPEEDR, 0x3U, (2 * pin), ospeed);
    }
}
...
__STATIC_INLINE void gpio_set_pin_pupdr(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->PUPDR, 0x3U, (2 * pin), pupd);
    }
}
...
__STATIC_INLINE void gpio_set_pin_odr(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->ODR, 0x1U, pin, od);
    }
}
...
__STATIC_INLINE void gpio_set_pin_afr(gpio_io_t io,
    ...
    if (p != NULL) {
        if (pin < 8U) {
            REG_SET_FIELD_POS(p->AFR[0], 0xFU, (4 * pin), af);
        } else {
            REG_SET_FIELD_POS(p->AFR[1], 0xFU, (4 * (pin - 8)), af);
        }
    }
}
...
__STATIC_INLINE void gpio_set_pin_ihystr(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->IHYSTR, 0x3U, (2 * pin), ihyst);
    }
}
...
__STATIC_INLINE void gpio_set_pin_trigenr(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->TRIGENR, 0x1U, pin, trigen);
    }
}
...
__STATIC_INLINE void gpio_set_pin_safeselr(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->SAFESELR, 0x1U, pin, safesel);
    }
}
...
__STATIC_INLINE void gpio_set_pin_safevalr(gpio_io_t io,
    ...
    if (p != NULL) {
        REG_SET_FIELD_POS(p->SAFEVALR, 0x1U, pin, safeval);
    }
}
