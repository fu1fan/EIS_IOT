...
#define HRTIM_COUNTER_RESET_TIMBCMP1               (0x1UL << 19U)  /**< 0x00080000 < Timer B compare 1 event         */
...
/**
 * @name    HRTIM Master Update Trigger
 * @note    Constants defining whether the registers update is done.
 * @{  
 */
#define HRTIM_MSTUPDATETRIGGER_REPETITION          (HRTIM_MCR_MREPU)      /*!< Register update is triggered when the master timer repetition period is completed */
/** @} */
...
/**
 * @name    HRTIM Timer External Event Blanking and Windowing
 * @note    Constants defining the Blanking and Windowing source applied to
 *          external events.
 * @{  
 */
...
/**
 * @enum hrtim_timer_mask_id_t
 * Supported HRTIM timer mask identifiers.
 */
typedef enum {
    HRTIM_TIMER_MASTER_MASK_ID = 0x01U,     /**< Timer Master mask identifier */
    HRTIM_TIMER_A_MASK_ID = 0x02U,          /**< Timer A mask identifier      */
    HRTIM_TIMER_B_MASK_ID = 0x04U,          /**< Timer B mask identifier      */
    HRTIM_TIMER_C_MASK_ID = 0x08U,          /**< Timer C mask identifier      */
    HRTIM_TIMER_D_MASK_ID = 0x10U,          /**< Timer D mask identifier      */
    HRTIM_TIMER_E_MASK_ID = 0x20U,          /**< Timer E mask identifier      */
    HRTIM_TIMER_F_MASK_ID = 0x40U,          /**< Timer F mask identifier      */
} hrtim_timer_mask_id_t;
 ...
 */
typedef enum {
    HRTIM_PRSC_MUL32 = 0,    /**< fHRCK = fHRTIM x 32 = 9.6 GHz - Resolution: 104 ps   - Min PWM frequency: 146.6 kHz (fHRTIM=300MHz) */
    HRTIM_PRSC_MUL16,        /**< fHRCK = fHRTIM x 16 = 4.8 GHz - Resolution: 208 ps   - Min PWM frequency: 73.26 KHz (fHRTIM=300MHz) */
    HRTIM_PRSC_MUL8,         /**< fHRCK = fHRTIM x 8 = 2.4 GHz  - Resolution: 416 ps   - Min PWM frequency: 36.63 kHz (fHRTIM=300MHz) */
    HRTIM_PRSC_MUL4,         /**< fHRCK = fHRTIM x 4 = 1.2 GHz  - Resolution: 833 ps   - Min PWM frequency: 18.31 kHz (fHRTIM=300MHz) */
    HRTIM_PRSC_MUL2,         /**< fHRCK = fHRTIM x 2 = 600 MHz  - Resolution: 1.66 ns  - Min PWM frequency: 9.16 kHz  (fHRTIM=300MHz) */
    HRTIM_PRSC_DIV1,         /**< fHRCK = fHRTIM = 300 MHz      - Resolution: 3.33 ns  - Min PWM frequency: 4.58 kHz  (fHRTIM=300MHz) */
    HRTIM_PRSC_DIV2,         /**< fHRCK = fHRTIM / 2 = 150 MHz  - Resolution: 6.66 ns  - Min PWM frequency: 2.29 kHz  (fHRTIM=300MHz) */
    HRTIM_PRSC_DIV4          /**< fHRCK = fHRTIM / 4 = 75 MHz   - Resolution: 13.33 ns - Min PWM frequency: 1.14 kHz  (fHRTIM=300MHz) */
} hrtim_prsc_t;
...
/**
 * @enum hrtim_out_mask_id_t
 * Supported HRTIM timer output mask identifiers.
 */
typedef enum {
    HRTIM_TIMER_A_OUT1_MASK_ID = 0x001U,    /**< Timer A out1 mask identifier */
    HRTIM_TIMER_A_OUT2_MASK_ID = 0x002U,    /**< Timer A out2 mask identifier */
    HRTIM_TIMER_B_OUT1_MASK_ID = 0x004U,    /**< Timer B out1 mask identifier */
    HRTIM_TIMER_B_OUT2_MASK_ID = 0x008U,    /**< Timer B out2 mask identifier */
    HRTIM_TIMER_C_OUT1_MASK_ID = 0x010U,    /**< Timer C out1 mask identifier */
    HRTIM_TIMER_C_OUT2_MASK_ID = 0x020U,    /**< Timer C out2 mask identifier */
    HRTIM_TIMER_D_OUT1_MASK_ID = 0x040U,    /**< Timer D out1 mask identifier */
    HRTIM_TIMER_D_OUT2_MASK_ID = 0x080U,    /**< Timer D out2 mask identifier */
    HRTIM_TIMER_E_OUT1_MASK_ID = 0x100U,    /**< Timer E out1 mask identifier */
    HRTIM_TIMER_E_OUT2_MASK_ID = 0x200U,    /**< Timer E out2 mask identifier */
    HRTIM_TIMER_F_OUT1_MASK_ID = 0x400U,    /**< Timer F out1 mask identifier */
    HRTIM_TIMER_F_OUT2_MASK_ID = 0x800U,    /**< Timer F out2 mask identifier */
} hrtim_out_mask_id_t;
...
typedef enum {
    ...
    HRTIM_NO_ADCTRIGGER = 10      /**< No trigger    */
...
typedef struct{
    ...
    uint32_t                 reset_mode;
    /**
     * @brief   Blanking enable status flag.
    */
...
/**
 * @enum hrtim_syncin_t
 * Supported HRTIM synchronization input events.
 */
typedef enum {
    HRTIM_SYNCIN_NONE,                 /*!< HRTIM is not synchronized and runs in standalone mode          */
    HRTIM_SYNCIN_HRTIM1,               /*!< Only for HRTIM2. The HRTIM2 is synchronized with hrtim1_scout1 */
    HRTIM_SYNCIN_TIM,                  /*!< The HRTIM is synchronized with the on-chip timer               */
    HRTIM_SYNCIN_EXTERNAL              /*!< A positive pulse on SYNCIN input triggers the HRTIM            */
} hrtim_syncin_t;

/**
 * @enum hrtim_syncout_t
 * Supported HRTIM synchronization output events.
 */
typedef enum {
    HRTIM_SYNCOUT_DISABLED,            /*!< Synchronization output event is disabled                                                                             */
    HRTIM_SYNCOUT_SIMULTANEOUS,        /*!< Simultaneous start of several HRTIM instances                                                                        */
    HRTIM_SYNCOUT_POSITIVE_PULSE,      /*!< SCOUT pin has a low idle level and issues a positive pulse of 16 fHRTIM clock cycles length for the synchronization  */
    HRTIM_SYNCOUT_NEGATIVE_PULSE       /*!< SCOUT pin has a high idle level and issues a negative pulse of 16 fHRTIM clock cycles length for the synchronization */
} hrtim_syncout_t;

/**
 * @enum hrtim_syncsrc_t
 * Supported HRTIM synchronization sources.
 */
typedef enum {
    HRTIM_SYNCSRC_MASTER_START,        /*!< A pulse is sent on HRTIM_SCOUT output and hrtim_out_sync2 upon master timer start event      */
    HRTIM_SYNCSRC_MASTER_CMP1,         /*!< A pulse is sent on HRTIM_SCOUT output and hrtim_out_sync2 upon master timer compare 1 event  */
    HRTIM_SYNCSRC_TIMA_START,          /*!< A pulse is sent on HRTIM_SCOUT output and hrtim_out_sync2 upon timer A start or reset events */
    HRTIM_SYNCSRC_TIMA_CMP1,           /*!< A pulse is sent on HRTIM_SCOUT output and hrtim_out_sync2 upon timer A compare 1 event       */
} hrtim_syncsrc_t;
 ...
 *            @arg @ref HRTIM_PRSC_MUL32
 *            @arg @ref HRTIM_PRSC_MUL16
 *            @arg @ref HRTIM_PRSC_MUL8
 *            @arg @ref HRTIM_PRSC_MUL4
 *            @arg @ref HRTIM_PRSC_MUL2
 ...
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] omask     output mask specifying the outputs to enable. It can be
 *                      a combination (OR) of the following values:
 *            @arg @ref HRTIM_TIMER_A_OUT1_MASK_ID
 *            @arg @ref HRTIM_TIMER_A_OUT2_MASK_ID
 *            @arg @ref HRTIM_TIMER_B_OUT1_MASK_ID
 *            @arg @ref HRTIM_TIMER_B_OUT2_MASK_ID
 *            @arg @ref HRTIM_TIMER_C_OUT1_MASK_ID
 *            @arg @ref HRTIM_TIMER_C_OUT2_MASK_ID
 *            @arg @ref HRTIM_TIMER_D_OUT1_MASK_ID
 *            @arg @ref HRTIM_TIMER_D_OUT2_MASK_ID
 *            @arg @ref HRTIM_TIMER_E_OUT1_MASK_ID
 *            @arg @ref HRTIM_TIMER_E_OUT2_MASK_ID
 *            @arg @ref HRTIM_TIMER_F_OUT1_MASK_ID
 *            @arg @ref HRTIM_TIMER_F_OUT2_MASK_ID
 *
 * @api
 */
void hrtim_timer_enable_output(hrtim_driver_t *hdp, uint16_t omask);
 ...
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] omask     output mask specifying the outputs to disable. It can
 *                      be a combination (OR) of the following values:
 *            @arg @ref HRTIM_TIMER_A_OUT1_MASK_ID
 *            @arg @ref HRTIM_TIMER_A_OUT2_MASK_ID
 *            @arg @ref HRTIM_TIMER_B_OUT1_MASK_ID
 *            @arg @ref HRTIM_TIMER_B_OUT2_MASK_ID
 ...
 * @api
 */
void hrtim_timer_disable_output(hrtim_driver_t *hdp, uint16_t omask);
 ...
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] tmask     timer mask specifying the timers to be enabled. It can
 *                      be a combination (OR) of the following values:
 *            @arg @ref HRTIM_TIMER_MASTER_MASK_ID
 *            @arg @ref HRTIM_TIMER_A_MASK_ID
 *            @arg @ref HRTIM_TIMER_B_MASK_ID
 *            @arg @ref HRTIM_TIMER_C_MASK_ID
 *            @arg @ref HRTIM_TIMER_D_MASK_ID
 *            @arg @ref HRTIM_TIMER_E_MASK_ID
 *            @arg @ref HRTIM_TIMER_F_MASK_ID
 *
 * @api
 */
void hrtim_timer_enable(hrtim_driver_t *hdp, uint8_t tmask);
 ...
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] tmask     timer mask specifying the timers to be disabled. It can
 *                      be a combination (OR) of the following values:
 *            @arg @ref HRTIM_TIMER_MASTER_MASK_ID
 *            @arg @ref HRTIM_TIMER_A_MASK_ID
 *            @arg @ref HRTIM_TIMER_B_MASK_ID
 ...
 * @api
 */
void hrtim_timer_disable(hrtim_driver_t *hdp, uint8_t tmask);
 ...
 *            @arg @ref HRTIM_COUNTER_RESET_TIMBCMP1
 ...
 * @param[in] update_src update sorce. For the master, it can be the following
 *            value:
 *            @arg @ref HRTIM_MSTUPDATETRIGGER_REPETITION
 *            For the other timers, it can be one of the following values:
...
/**
 * @brief   Enables timer(s) update.
 * @note    This function must be invoked after hrtim_start, otherwise it has
 *          no effect.
 *
 * @param[in] hdp       pointer to HRTIM handle
 * @param[in] tmask     timer mask specifying the timers for which to enable
 *                      the update. It can be a combination (OR) of the
 *                      following values:
 *            @arg @ref HRTIM_TIMER_MASTER_MASK_ID
 *            @arg @ref HRTIM_TIMER_A_MASK_ID
 *            @arg @ref HRTIM_TIMER_B_MASK_ID
 ...
 * @api
 */
void hrtim_timer_enable_update(hrtim_driver_t *hdp, uint8_t tmask);

/**
 * @brief   Disables timer(s) update.
 * @note    This function must be invoked after hrtim_start, otherwise it has
 *          no effect.
 *
 * @param[in] hdp       pointer to HRTIM handle
 * @param[in] tmask     timer mask specifying the timers for which to disable
 *                      the update. It can be a combination (OR) of the
 *                      following values:
 *            @arg @ref HRTIM_TIMER_MASTER_MASK_ID
 *            @arg @ref HRTIM_TIMER_A_MASK_ID
 ...
 * @api
 */
void hrtim_timer_disable_update(hrtim_driver_t *hdp, uint8_t tmask);
 ...
 * @param[in] event_trigger event triggering the ADC. The ADC triggers 1/3 and
 *                      2/4 can select the ORed of HRTIM_ADCTRIGGEREVENT13_xx,
 *                      HRTIM_ADCTRIGGEREVENT24_xx values respectively. 
 *                      The ADC triggers 5/7/9 and 6/8/10 can ONLY select one
 *                      value of HRTIM_ADCTRIGGEREVENT579_xx,
 *                      HRTIM_ADCTRIGGEREVENT6810_xx respectively:
 ...
 *
 * @param[in] hdp       pointer to an @p hrtim_driver_t structure
 * @param[in] eev_idx   External event to be configured. It can be one of the
 *                      following values:
 ...
 * @note    This configuration is valid only for events 6-10.
 * 
 * @param[in] hdp       pointer to an @p hrtim_driver_t structure
 ...
 * @param[in] blanking_enable blanking enable status flag.('true' means the
 *                      blanking is enabled, 'false' otherwise).
...
/**
 * @brief   Configures HRTIM synchronization input.
 * @note    This configuration becomes effective after hrtim_start.
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] sync_in   synchronization input to be configured. It can be one
 *                      of the following values:
 *            @arg @ref HRTIM_SYNCIN_NONE
 *            @arg @ref HRTIM_SYNCIN_HRTIM1
 *            @arg @ref HRTIM_SYNCIN_TIM
 *            @arg @ref HRTIM_SYNCIN_EXTERNAL
 * @return              previous synchronization input. It can be one of the
 *                      following values:
 *            @arg @ref HRTIM_SYNCIN_NONE
 *            @arg @ref HRTIM_SYNCIN_HRTIM1
 *            @arg @ref HRTIM_SYNCIN_TIM
 ...
 * @api
 */
hrtim_syncin_t hrtim_set_sync_in(hrtim_driver_t *hdp, hrtim_syncin_t sync_in);

/**
 * @brief   Configures HRTIM synchronization output.
 * @note    This configuration becomes effective after hrtim_start.
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] sync_out  synchronization output to be configured. It can be one
 *                      of the following values:
 *            @arg @ref HRTIM_SYNCOUT_DISABLED    
 *            @arg @ref HRTIM_SYNCOUT_SIMULTANEOUS
 *            @arg @ref HRTIM_SYNCOUT_POSITIVE_PULSE
 *            @arg @ref HRTIM_SYNCOUT_NEGATIVE_PULSE
 * @return              previous synchronization output. It can be one of the
 *                      following values:
 *            @arg @ref HRTIM_SYNCOUT_DISABLED    
 *            @arg @ref HRTIM_SYNCOUT_SIMULTANEOUS
 *            @arg @ref HRTIM_SYNCOUT_POSITIVE_PULSE
 ...
 * @api
 */
hrtim_syncout_t hrtim_set_sync_out(hrtim_driver_t *hdp,
                                   hrtim_syncout_t sync_out);

/**
 * @brief   Configures HRTIM synchronization source.
 * @note    This configuration becomes effective after hrtim_start.
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] sync_src  synchronization source to be configured. It can be one
 *                      of the following values:
 *            @arg @ref HRTIM_SYNCSRC_MASTER_START
 *            @arg @ref HRTIM_SYNCSRC_MASTER_CMP1
 *            @arg @ref HRTIM_SYNCSRC_TIMA_START
 *            @arg @ref HRTIM_SYNCSRC_TIMA_CMP1
 * @return              previous synchronization source. It can be one of the
 *                      following values:
 *            @arg @ref HRTIM_SYNCSRC_MASTER_START
 *            @arg @ref HRTIM_SYNCSRC_MASTER_CMP1
 *            @arg @ref HRTIM_SYNCSRC_TIMA_START
 ...
 * @api
 */
hrtim_syncsrc_t hrtim_set_sync_src(hrtim_driver_t *hdp,
                                   hrtim_syncsrc_t sync_src);

/**
 * @brief   Enables/Disables HRTIM synchronization start.
 * @note    This configuration becomes effective after hrtim_start.
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] timer     master/timer to be configured. It can be one of the
 ...
 *            @arg @ref HRTIM_TIMER_F
 *            @arg @ref HRTIM_TIMER_MASTER
 * @param[in] enable    synchronization start enable status ('true' means the
 *                      synchronization start is enabled, 'false' otherwise)
 * @return              previous synchronization start enable status.
 *
 * @api
 */
bool hrtim_enable_sync_start(hrtim_driver_t *hdp, hrtim_timer_t timer,
                             bool enable);

/**
 * @brief   Enables/Disables HRTIM synchronization reset.
 * @note    This configuration becomes effective after hrtim_start.
 *
 * @param[out] hdp      pointer to a @p hrtim_driver_t structure
 * @param[in] timer     master/timer to be configured. It can be one of the
 ...
 *            @arg @ref HRTIM_TIMER_F
 *            @arg @ref HRTIM_TIMER_MASTER
 * @param[in] enable    synchronization reset enable status ('true' means the
 *                      synchronization reset is enabled, 'false' otherwise)
 * @return              previous synchronization reset enable status.
 *
 * @api
 */
bool hrtim_enable_sync_reset(hrtim_driver_t *hdp, hrtim_timer_t timer,
                             bool enable);
