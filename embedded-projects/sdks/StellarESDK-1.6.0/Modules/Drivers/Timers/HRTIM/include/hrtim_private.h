...
struct hrtim_driver {
    ...
    /**
     * @brief   Master synchronization start enable flag.
     */
    bool                     is_master_sync_start;
    /**
     * @brief   Master synchronization reset enable flag.
     */
    bool                     is_master_sync_reset;
    /**
     * @brief   Timer synchronization start enable flags.
     */
    bool                     is_timer_sync_start[HRTIM_TIMER_NUM];
    /**
     * @brief   Timer synchronization reset enable flags.
     */
    bool                     is_timer_sync_reset[HRTIM_TIMER_NUM];
};
