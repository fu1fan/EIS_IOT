...
uint8_t tim_dev_get_ch_num(tim_driver_t *tdp) {
    ...
    if (tdp == &DRV_TIM1 || tdp == &DRV_TIM8) {
        ch_num = 6U;
    } else if (tdp == &DRV_TIM2 || tdp == &DRV_TIM3 ||
               tdp == &DRV_TIM4 || tdp == &DRV_TIM5) {
        ch_num = 4U;
    } else if (tdp == &DRV_TIM15) {
        ch_num = 2U;
...
/**
 * @brief   Returns TIM DMA update trigger.
 *
 * @param[in] tdp       pointer to a @p tim_driver_t structure
 * @return              DMA update trigger.
 *
 * @notapi
 */
uint32_t tim_dev_get_update_dma_trigger(tim_driver_t *tdp) {

    if (tdp == &DRV_TIM1) {
        return DMAMUX1_TIM1_UP;
    } else if (tdp == &DRV_TIM2) {
        return DMAMUX1_TIM2_UP;
    } else if (tdp == &DRV_TIM3) {
        return DMAMUX1_TIM3_UP;
    } else if (tdp == &DRV_TIM4) {
        return DMAMUX1_TIM4_UP;
    } else if (tdp == &DRV_TIM5) {
        return DMAMUX1_TIM5_UP;
    } else if (tdp == &DRV_TIM6) {
        return DMAMUX1_TIM6_UP;
    } else if (tdp == &DRV_TIM7) {
        return DMAMUX1_TIM7_UP;
    } else if (tdp == &DRV_TIM8) {
        return DMAMUX1_TIM8_UP;
    } else if (tdp == &DRV_TIM15) {
        return DMAMUX1_TIM15_UP;
    } else {
        return DMAMUX1_TIM16_UP;
    }
}

/**
 * @brief   Returns TIM DMA channel trigger.
 *
 * @param[in] tdp       pointer to a @p tim_driver_t structure
 * @return              DMA channel trigger.
 *
 * @notapi
 */
uint32_t tim_dev_get_channel_dma_trigger(tim_driver_t *tdp, uint8_t channel) {

    if (tdp == &DRV_TIM1) {
        if (channel == 1U) {
            return DMAMUX1_TIM1_CH1;
        } else if (channel == 2U) {
            return DMAMUX1_TIM1_CH2;
        } else if (channel == 3U) {
            return DMAMUX1_TIM1_CH3;
        } else {
            return DMAMUX1_TIM1_CH4;
        }
    } else if (tdp == &DRV_TIM2) {
        if (channel == 1U) {
            return DMAMUX1_TIM2_CH1;
        } else if (channel == 2U) {
            return DMAMUX1_TIM2_CH2;
        } else if (channel == 3U) {
            return DMAMUX1_TIM2_CH3;
        } else {
            return DMAMUX1_TIM2_CH4;
        }
    } else if (tdp == &DRV_TIM3) {
        if (channel == 1U) {
            return DMAMUX1_TIM3_CH1;
        } else if (channel == 2U) {
            return DMAMUX1_TIM3_CH2;
        } else if (channel == 3U) {
            return DMAMUX1_TIM3_CH3;
        } else {
            return DMAMUX1_TIM3_CH4;
        }
    } else if (tdp == &DRV_TIM4) {
        if (channel == 1U) {
            return DMAMUX1_TIM4_CH1;
        } else if (channel == 2U) {
            return DMAMUX1_TIM4_CH2;
        } else if (channel == 3U) {
            return DMAMUX1_TIM4_CH3;
        } else {
            return DMAMUX1_TIM4_CH4;
        }
    } else if (tdp == &DRV_TIM5) {
        if (channel == 1U) {
            return DMAMUX1_TIM5_CH1;
        } else if (channel == 2U) {
            return DMAMUX1_TIM5_CH2;
        } else if (channel == 3U) {
            return DMAMUX1_TIM5_CH3;
        } else {
            return DMAMUX1_TIM5_CH4;
        }
    } else if (tdp == &DRV_TIM8) {
        if (channel == 1U) {
            return DMAMUX1_TIM8_CH1;
        } else if (channel == 2U) {
            return DMAMUX1_TIM8_CH2;
        } else if (channel == 3U) {
            return DMAMUX1_TIM8_CH3;
        } else {
            return DMAMUX1_TIM8_CH4;
        }
    } else if (tdp == &DRV_TIM15) {
        return DMAMUX1_TIM15_CH1;
    } else {
        return DMAMUX1_TIM16_CH1;
    }
}
