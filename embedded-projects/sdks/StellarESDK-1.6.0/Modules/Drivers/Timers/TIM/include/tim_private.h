...
struct tim_driver {
    ...
    uint32_t                 clock;
    /**
     * @brief   One pulse mode status flag.
     * @note    True means one pulse mode is enabled, false otherwise.
     */
    bool                     is_opm_en;
    /**
    ...
    tim_etp_t                etp;
    /**
     * @brief   Break event flag.
     * @note    Flag set on true when break event is enabled, false otherwise.
     */
    bool                     is_bk_en;
    /**
    ...
    tim_bkp_t                bkp;
    /**
     * @brief   Break 2 event flag.
     * @note    Flag set on true when break 2 event is enabled, false otherwise.
     */
    bool                     is_bk2_en;
    /**
    ...
    tim_bkp_t                bk2p;
    /**
     * @brief   TIM input 1 selection.
     */
    tim_ti1s_t               ti1s;
    /**
     * @brief   Capture/compare preloaded control enable flag.
     */
    bool                     is_ccpc_en;
    /**
     * @brief   Capture/compare/update DMA configurations.
     */
    tim_dma_conf_t           dma_conf[TIM_DMA_OPS_MAX];
    /**
     * @brief   Capture/compare/update allocated DMA descriptors.
     */
    const dma_descriptor_t   *dma_descriptor[TIM_DMA_OPS_MAX];
    /**
