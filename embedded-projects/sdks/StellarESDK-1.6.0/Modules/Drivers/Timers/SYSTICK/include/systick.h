 ...
 * @api
 */
uint64_t systick_s2tk(systick_driver_t *sdp, uint32_t sec);
 ...
 * @api
 */
uint64_t systick_ms2tk(systick_driver_t *sdp, uint32_t msec);
 ...
 * @api
 */
uint64_t systick_us2tk(systick_driver_t *sdp, uint32_t usec);
 ...
 * @api
 */
uint64_t systick_ns2tk(systick_driver_t *sdp, uint32_t nsec);
