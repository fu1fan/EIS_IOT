...
static void can_reset_paramters(can_driver_t *cdp) {
    ...
    cdp->dma_conf.dma_stream_tx_id    = DMA1_STREAM0_ID;
    cdp->dma_conf.dma_stream_rx0_id   = DMA1_STREAM1_ID;
    cdp->dma_conf.dma_stream_rx1_id   = DMA1_STREAM2_ID;
...
void can_set_dma_conf(can_driver_t *cdp, can_dma_conf_t *dma_conf) {

    cdp->dma_conf.dma_stream_tx_id    = dma_conf->dma_stream_tx_id;
    cdp->dma_conf.dma_stream_rx0_id   = dma_conf->dma_stream_rx0_id;
    cdp->dma_conf.dma_stream_rx1_id   = dma_conf->dma_stream_rx1_id;
