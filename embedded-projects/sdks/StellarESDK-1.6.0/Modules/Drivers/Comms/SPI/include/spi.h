...
/**
 * @enum spi_cmode_t
 * SPI supported communication modes.
 */
typedef enum {
    SPI_CMODE_FULL_DUPLEX,             /**< Full duplex communication */
    SPI_CMODE_HALF_DUPLEX,             /**< Half duplex communication */
} spi_cmode_t;
 ...
 */
typedef enum {
    SPI_STATUS_OK,           /**< SPI status = no error      */
    SPI_STATUS_TIMEOUT       /**< SPI status = timeout error */
} spi_status_t;
 ...
 */
typedef void (*spi_cb_t)(spi_driver_t *sdp);
...
/**
 * @brief   Configures SPI communication mode (full or half duplex).
 * @note    This configuration becomes effective after spi_start.
 *
 * @param[out] sdp      pointer to a @p spi_driver_t structure
 * @param[in] cmode     SPI communication mode to be configured. It can be one
 *                      of the following values:
 *            @arg @ref SPI_CMODE_FULL_DUPLEX
 *            @arg @ref SPI_CMODE_HALF_DUPLEX
 * @return              previous SPI communication mode. It can be one of the
 *                      following values:
 *            @arg @ref SPI_CMODE_FULL_DUPLEX
 *            @arg @ref SPI_CMODE_HALF_DUPLEX
 *
...
/**
 * @brief   Configures SPI timeout [ms].
 * @note    Timeout is taken into account only for synchronous modes:
 *          SPI_DRV_MODE_INT_SYNC
 *          SPI_DRV_MODE_DMA_SYNC
 *
 * @param[out] sdp      pointer to a @p spi_driver_t structure
 * @param[in] timeout   timeout [ms] to be configured.
 ...
 * @note    This API can be used only in full duplex mode.
...
/**
 * @brief   Returns the SPI status.
 *
 * @param[in] sdp       pointer to a @p spi_driver_t structure
 * @return              SPI status. It can be one of the following values:
 *            @arg @ref SPI_STATUS_OK
 *            @arg @ref SPI_STATUS_TIMEOUT
 *
 * @api
 */
