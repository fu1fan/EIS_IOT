...
/**
 * @name    EEPROM Emulation Driver number of blocks
 * @{
 */
#define EED_BLOCK_NUMBER                    4U
/** @} */

/**
 * @name    EEPROM Emulation Driver program granularity
 * @{
 */
#define EDD_PROGRAM_CHUNK_SIZE              8U
/** @} */

/**
 * @name    EEPROM Emulation Driver sizes
 * @{
 */
#define EDD_BLOCK_METADATA_SIZE             16U
#define EED_ID_STATUS_SIZE                  8U
#define EED_ID_NUM_SIZE                     2U
#define EED_ID_SIZE_SIZE                    2U
#define EED_ID_METADATA_SIZE                (EED_ID_STATUS_SIZE + EED_ID_NUM_SIZE + EED_ID_SIZE_SIZE)
#define EED_ID_MIN_DATA_SIZE                4U
/** @} */
...
typedef struct {
     ...
     */
    eed_blk_cfg_t            blk_cfg[EED_BLOCK_NUMBER];
} eed_cfg_t;
 ...
 * @param[out] source   addrress of buffer in which data of  the record to be
 *                      read is stored
 * @return              operation status: EED_OK if the record is correctly
