...
/**
 * @file    evbe3000d.h
 * @brief   SR5E1-EVBE3000D board header file.
 *
 * @addtogroup PLATFORM
 * @addtogroup BOARD
 * @ingroup PLATFORM
...
/* GPIOD[10] is used to drive the USER_LED_D12
...
#define HRTIM1_CHE2_CFG                          \
    (GPIO_MODE_MODER_ALTERNATE |                 \
     ...
     GPIO_MODE_SAFEVALR_LOW)
*/
#define USER_LED_D12 gpio_iopack(GPIO_PORT_D, GPIO_PIN_10)
#define USER_LED_D12_CFG                         \
...
/* PortH pin settings. */
/* GPIOH[0] is used for the PUSH BUTTON P_B1
...
#define TIM3_CH3_CFG                             \
    (GPIO_MODE_MODER_ALTERNATE |                 \
     ...
     GPIO_MODE_SAFEVALR_LOW)
*/
#define USER_P_B1 gpio_iopack(GPIO_PORT_H, GPIO_PIN_0)
#define USER_P_B1_CFG                            \
    (GPIO_MODE_MODER_OUTPUT |                    \
     GPIO_MODE_OTYPER_PUSHPULL |                 \
     GPIO_MODE_OSPEEDR_HIGH |                    \
     GPIO_MODE_PUPDR_FLOATING |                  \
...
__STATIC_INLINE void evbe3000d_init(void) {
    ...
    gpio_set_pin_mode(USER_LED_D12, USER_LED_D12_CFG);
    ...
    /* PortH pin settings. */
    gpio_set_pin_mode(USER_P_B1, USER_P_B1_CFG);
