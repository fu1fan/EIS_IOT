...
typedef struct
{
  ...
  __I  uint32_t GR_S;               /*!< GR_S              Address offset: 0x080 */
  __I  uint32_t GR_P;               /*!< GR_P              Address offset: 0x084 */
  ...
  __IO uint32_t FEE_TD;             /*!< FEE_TD            Address offset: 0x318 */
       uint32_t RESERVED6[43];      /*!< Reserved          Address offset: 0x31C-0x3C4 */
  __I  uint32_t BIST_MASK_STATUS;   /*!< BIST_MASK_STATUS  Address offset: 0x3C8 */
  __I  uint32_t BIST_FLAGS_PHASE1;  /*!< BIST_FLAGS_PHASE1 Address offset: 0x3CC */
  __I  uint32_t BIST_FLAGS_PHASE2;  /*!< BIST_FLAGS_PHASE2 Address offset: 0x3D0 */
  ...
  __I  uint32_t BIST_DEBUG;         /*!< BIST_DEBUG        Address offset: 0x3E4 */
} PMC_DIG_TypeDef;
...
#define PMC_DIG_BASE           0x4001D000UL 
