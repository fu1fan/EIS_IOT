 ...
 * @param[in] _field_   name of field to be set
 * @param[in] _value_   value to which the field is set
 *
 * @api
 */
 ...
 *
 * @param[in] _regp_    pointer to the register contains the field to be set
 * @param[in] _mask_    mask of field to be set
 * @param[in] _pos_     position of field to be set
 * @param[in] _value_   value to which the field is set
 *
 * @api
 */
#define REG_SET_FIELD_POS(_regp_, _mask_, _pos_, _value_)            \
    ((_regp_) = (((_regp_) & (~(((uint32_t)(_mask_)) << ((uint32_t)(_pos_))))) | (((uint32_t)((_mask_) & (_value_))) << ((uint32_t)(_pos_)))))
