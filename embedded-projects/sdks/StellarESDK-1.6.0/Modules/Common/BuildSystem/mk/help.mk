...
help:
	...
	@echo "  BUILD_DRIVERS_CMU                set to '1' to build CMU driver, '0' to exclude it from build"
	...
	@echo "  BUILD_DRIVERS_CRC                set to '1' to build CRC driver, '0' to exclude it from build"
	...
	@echo "  BUILD_DRIVERS_I2C                set to '1' to build I2C driver, '0' to exclude it from build"
	...
	@echo "  BUILD_DRIVERS_LIN                set to '1' to build LIN driver, '0' to exclude it from build"
	@echo "  BUILD_DRIVERS_MPU                set to '1' to build MPU driver, '0' to exclude it from build"
	@echo "  BUILD_DRIVERS_PMU                set to '1' to build PMU driver, '0' to exclude it from build"
	@echo "  BUILD_DRIVERS_RTC                set to '1' to build RTC driver, '0' to exclude it from build"
	...
	@echo "  BUILD_DRIVERS_SENT               set to '1' to build SENT driver, '0' to exclude it from build"
	@echo "  BUILD_DRIVERS_SMPU               set to '1' to build SMPU driver, '0' to exclude it from build"
	...
	@echo "  BUILD_DRIVERS_TIM_TS             set to '1' to build TIM_TS driver, '0' to exclude it from build"
	@echo "  BUILD_DRIVERS_TSENS              set to '1' to build TSENS driver, '0' to exclude it from build"
	...
	@echo "  BUILD_OS_FREERTOS                set to '1' to build FreeRTOS, '0' to exclude it from build"
	@echo "  BUILD_OS_FREERTOS_CONSOLE        set to '1' to build FreeRTOS console, '0' to exclude it from build"
	...
	@echo ' '
	@echo "Set Board name:"
	@echo "  CONFIG_BOARD                     set board name: evbe7000p (default), evbe7000s, evbe3000p, evbe7000e, evbe3000e, evbe3000d"
	@echo ' '
	@echo "Set core:"
