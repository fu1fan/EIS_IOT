...
TARGET_BUILD     ?= Debug
TARGET_BUILD_DIR := build/$(CONFIG_DEVICE)/$(CONFIG_BOARD)/$(TARGET_CORE_DIR)/$(TARGET_BUILD)
...
BUILD_DRIVERS_CEM              ?= 0
BUILD_DRIVERS_CMU              ?= 0
BUILD_DRIVERS_COMP             ?= 0
BUILD_DRIVERS_CORDIC           ?= 0
BUILD_DRIVERS_CRC              ?= 0
BUILD_DRIVERS_DAC              ?= 0
BUILD_DRIVERS_DMA              ?= 0
BUILD_DRIVERS_DWT              ?= 0
BUILD_DRIVERS_EED              ?= 0
BUILD_DRIVERS_EXTI             ?= 0
BUILD_DRIVERS_FCCU             ?= 0
BUILD_DRIVERS_FLASH            ?= 0
BUILD_DRIVERS_GPIO             ?= 1
BUILD_DRIVERS_HRTIM            ?= 0
BUILD_DRIVERS_HSEM             ?= 0
BUILD_DRIVERS_I2C              ?= 0
BUILD_DRIVERS_I2S              ?= 0
BUILD_DRIVERS_ILI9341          ?= 0
BUILD_DRIVERS_IWDG             ?= 0
BUILD_DRIVERS_MPU              ?= 0
BUILD_DRIVERS_RTC              ?= 0
BUILD_DRIVERS_SARADC           ?= 0
BUILD_DRIVERS_SDADC            ?= 0
BUILD_DRIVERS_SENT             ?= 0
BUILD_DRIVERS_SMPU             ?= 0
BUILD_DRIVERS_SPI              ?= 0
BUILD_DRIVERS_SYSTICK          ?= 0
BUILD_DRIVERS_TIM              ?= 0
BUILD_DRIVERS_TIM_TS           ?= 0
BUILD_DRIVERS_TSENS            ?= 0
BUILD_DRIVERS_UART             ?= 0
BUILD_DRIVERS_WWDG             ?= 0
