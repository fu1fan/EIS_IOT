...
#define TFT180_RST_PIN                  ( LCD_RST_G6 )
#define TFT180_DC_PIN                   ( LCD_DC_H1 )
#define TFT180_CS_PIN                   ( LCD_CS_H12 )

#define TFT180_RST_PIN                  ( LCD_RST_G6 )
#define TFT180_DC_PIN                   ( LCD_DC_H1 )
#define TFT180_CS_PIN                   ( LCD_CS_H12 )

#define TFT180_RST(x)   ((x) ? (gpio_set_pin(TFT180_RST_PIN)) : (gpio_clear_pin(TFT180_RST_PIN)))
#define TFT180_DC(x)    ((x) ? (gpio_set_pin(TFT180_DC_PIN))  : (gpio_clear_pin(TFT180_DC_PIN)))
#define TFT180_CS(x)    ((x) ? (gpio_set_pin(TFT180_CS_PIN))  : (gpio_clear_pin(TFT180_CS_PIN)))
...
#define TFT180_BLK_DUTY ( 100 )                                                  // 背光亮度调节 0-100
//=================================================定义 TFT180 基本配置================================================
